...
LIB_ECCODES   ?= -L$(DIR_ECCODES_INSTALL)/lib -L$(DIR_ECCODES_INSTALL)/lib64 -leccodes_f90 -leccodes -lstdc++
INC           += $(INC_ECCODES)
LIBS          += $(LIB_ECCODES)
...
#
CDF_PATH       ?= $(shell $(NETCDF_CONFIG) --prefix)
...
PROG_LIST += MESONH  LATLON_TO_XY PREP_IDEAL_CASE PREP_REAL_CASE PREP_PGD \
            PREP_NEST_PGD SPAWNING DIAG PREP_SURFEX SPECTRE MNH2LPDM
ifdef MNH_TOOLS
PROG_LIST += LFI2CDF
endif
#endif
